  ...
  const loadAllData = useCallback(async () => {
    ...
    try {
      ...
      setAulas(aulasData.map((a: any) => ({
        ...
        instrutor: a.instrutor?.nome || a.nome_instrutor || '',
        curso: a.curso?.nome || a.disciplina?.curso?.nome_curso || a.nome_curso || '',
        materia: a.materia?.nome || a.disciplina?.nome_disciplina || a.nome_materia || '',
        sala: a.sala || '',
